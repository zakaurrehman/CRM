        ...
        {industries.map((industry, i) => (
          <Reveal key={industry.slug} delay={i * 80}>
            <Link
              ...
              className="group relative flex min-h-[22rem] flex-col justify-end overflow-hidden rounded-md border border-white/10 p-7 transition-colors duration-300 hover:border-white/25 lg:min-h-[26rem] lg:p-9"
            >
              <Image
                src={industry.image}
                alt=""
