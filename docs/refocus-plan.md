...
One deviation from the published plan: Stainless Steel sits in a group named
...
| Ferro Alloys & Stainless | FeNiCr (+ FeW, FeMo, FeNb, FeTi as a second line, Q2) | — |
| | Stainless Steel | Stainless Steel (24) |
...
| Refractory & Rare Metals | Tungsten & Moly — 8%+ | Tungsten Alloys (10) + the nine tungsten forms |
| | Niobium — 10%+ | — |
| | Tantalum — 10%+ | — |
...
| Q2 | FeW, FeMo, FeNb, FeTi — still offered? | Kept as a second line under FeNiCr until confirmed. |
| Q3 | The 19 residue streams (AOD/EAF dust, filtercake, mill scale, sludge…) — still accepted? | Page retired. "Dusts" in the six forms covers what is still relevant. |
