  ...
  return (
    <Container>
      <div className="flex min-h-[60vh] flex-col justify-center py-20">
        ...
        <h1 className="mt-4 text-display-lg">This page could not be found.</h1>
        <p className="mt-6 max-w-xl text-lg leading-relaxed text-steel-600">
          The page may have moved during our site rebuild. Try the materials directory, or search for the
          alloy grade or stream you were looking for.
        </p>
